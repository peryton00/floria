# Floria Premium SVG Icon System
...
- no gradients or baked-in colors
...
- `admin/` — seller/admin dashboards and management
...
- Seller/admin panels: admin
- Buttons and utility controls: actions

Avoid mixing different icon families inside the same small navigation group.
