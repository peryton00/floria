...
export function SellerStatusBadge({
  ...
  switch (status) {
    ...
    case "rejected":
      return (
        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider bg-ink-200 text-ink-700 border border-ink-300">
          ✕ Rejected
        </span>
      );
    default:
