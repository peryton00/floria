...
const STEPS = [
  {
    ...
    description:
      "Explore living indoor plants, organic seeds, planters, and fertilizers sourced directly from trusted nurseries near you.",
  },
  {
    step: "02",
    title: "Multi-Nursery Unified Cart",
    description:
      "Combine items from different nurseries into a single cart. Floria handles split orders and local seller routing automatically.",
  },
  {
    step: "03",
    title: "Eco-Friendly Safe Packaging",
    description:
      "Our nursery partners package your plants in custom breathable boxes designed to protect leaves and retain soil moisture.",
  },
  {
    step: "04",
    title: "Express Local Delivery & Plant Guarantee",
    description:
      "Receive your plants fresh at your doorstep. Every plant is backed by our 7-day health replacement guarantee.",
  },
];
      ...
      <div className="space-y-12 py-4 max-w-4xl mx-auto">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-ink-600 leading-relaxed">
            We bridge the gap between passionate plant parents and local nursery
            growers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {STEPS.map((s) => (
            <div
              key={s.step}
              className="bg-white rounded-2xl border border-ink-100 p-6 shadow-sm space-y-3"
            >
        ...
        <div className="bg-cream-100 rounded-2xl border border-ink-100 p-8 space-y-4">
          ...
          <ul className="space-y-3 text-xs text-ink-700">
            ...
            <li className="flex items-center gap-2">
              <CheckIcon size={16} className="text-forest-700 shrink-0" />
              <span>
                7-Day Plant Guarantee: Free replacements if your plant arrives
                damaged.
              </span>
            </li>
            <li className="flex items-center gap-2">
