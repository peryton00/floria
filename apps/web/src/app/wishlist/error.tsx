...
export default function Error({
  ...
  useEffect(() => {
    console.error("\[Floria/wishlist\]", error);
  }, [error]);

  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
      <h2 className="text-xl font-bold text-ink-900 mb-2">Wishlist couldn&apos;t load</h2>
      <p className="text-sm text-ink-500 mb-6">Something went wrong loading your wishlist.</p>
