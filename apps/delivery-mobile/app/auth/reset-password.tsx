...
export default function ResetPasswordScreen() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      const res = await api.resetDeliveryPartnerPassword({
        token: token.trim(),
        password,
      });
      ...
      setError(e.message || "Failed to reset password. Please verify token.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        <View style={styles.brandHeader}>
          <View style={styles.logoBadge}>
            <FloriaIcon name="lock" size={32} color={theme.colors.forest} />
          </View>
          <Text style={styles.brandTitle}>RESET PASSWORD</Text>
          <Text style={styles.brandSubtitle}>Floria Courier Dispatch Portal</Text>
        </View>
        ...
        {success ? (
          <View style={styles.card}>
            ...
            <Text style={styles.successMessage}>
              Your courier dispatch password has been successfully updated. You can now log in with your new credentials.
            </Text>
            <TouchableOpacity
              activeOpacity={0.85}
          ...
          <View style={styles.card}>
            ...
            >
              <Text style={styles.backLinkText}>Cancel & Return to Login</Text>
            </TouchableOpacity>
          </View>
        )}
      </ScrollView>
