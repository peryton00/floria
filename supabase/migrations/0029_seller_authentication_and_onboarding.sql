-- ============================================================
-- Floria — Migration 0029: Seller Authentication & Onboarding
-- Controlled Migration: Dedicated Seller Identity, Credentials,
-- Applications, Password Recovery & Admin Review Workflow.
-- ============================================================

-- 1. Extend seller_status ENUM with all required lifecycle states
DO $$ BEGIN
...
-- 2. Add public_seller_id, username, gst_number to seller_profiles (backward-safe)
...
-- 3. Backfill public_seller_id for existing seller_profiles
...
-- Note: seller_credentials, seller_applications, seller_password_resets are
-- accessed and managed by @floria/api via Supabase service-role (getAdminDb).
