...
declare class FloriaApiClient {
  ...
  >;
  createPaymentSession(orderId: string): Promise<
    ApiResponse<{
      paymentId: string;
  ...
  >;
  getOrderByCfOrderId(cfOrderId: string): Promise<
    ApiResponse<{
      orderId: string;
    }>
  >;
  ...
  attachSellerDocument(
    documentType: string,
    fileAssetId: string,
  ): Promise<ApiResponse<any>>;
  getSignedDocumentUrl(documentId: string): Promise<
    ApiResponse<{
      signedUrl: string;
      filename?: string;
    }>
  ...
  getSellerNotificationSettings(): Promise<
  ...
  getCategoryProductsCount(id: string): Promise<
    ApiResponse<{
      categoryId: string;
  ...
  >;
  updateCommissionRate(commissionRate: number): Promise<
    ApiResponse<{
      commissionRate: number;
    }>
  >;
  ...
  updateDeliveryStatus(
    id: string,
    status: _floria_types.DeliveryAssignmentStatus | string,
  ): Promise<ApiResponse<_floria_types.DeliveryAssignment>>;
  completeDeliveryWithPod(
    id: string,
    data: _floria_types.CompleteDeliveryPayload,
  ): Promise<ApiResponse<_floria_types.DeliveryAssignment>>;
  getDeliveryPod(
    id: string,
  ): Promise<ApiResponse<_floria_types.DeliveryPodDetails>>;
  ...
  >;
  completeUploadSession(sessionId: string): Promise<
    ApiResponse<{
      sessionId: string;
      assetId: string;
  ...
  getReviewEligibility(productId: string): Promise<
    ApiResponse<{
      canReview: boolean;
      reason?: string;
  ...
  flagReview(reviewId: string): Promise<
    ApiResponse<{
      flagged: boolean;
    }>
  >;
  ...
  getAdminProductFinancialCalculation(
    productId: string,
  ): Promise<ApiResponse<_floria_types.AdminProductFinancialCalculation>>;
  getAdminOrderFinancialBreakdown(
    orderId: string,
  ): Promise<ApiResponse<_floria_types.AdminOrderFinancialBreakdown>>;
  getDeliverySettings(): Promise<ApiResponse<_floria_types.DeliverySettings>>;
  updateDeliverySettings(
    updates: Partial<_floria_types.DeliverySettings>,
  ): Promise<ApiResponse<_floria_types.DeliverySettings>>;
  previewDeliveryFee(
    subtotalPaise: number,
  ): Promise<ApiResponse<_floria_types.DeliveryCalculationResult>>;
  getFinancialSettings(): Promise<ApiResponse<_floria_types.FinancialSettings>>;
  updateFinancialSettings(
    updates: Partial<_floria_types.FinancialSettings>,
  ): Promise<ApiResponse<_floria_types.FinancialSettings>>;
  getPricingPolicies(): Promise<
    ApiResponse<{
      policies: _floria_types.PricingPolicyVersion[];
    }>
  >;
  getActivePricingPolicy(): Promise<
    ApiResponse<_floria_types.PricingPolicyVersion | null>
  >;
  ...
  previewPricingPolicyImpact(
    policyId: string,
  ): Promise<ApiResponse<_floria_types.PolicyImpactPreview>>;
  startPricingRecalculation(
    policyId: string,
  ): Promise<ApiResponse<_floria_types.PricingRecalculationJob>>;
  getPricingRecalculationStatus(
    policyId: string,
  ): Promise<ApiResponse<_floria_types.PricingRecalculationJob | null>>;
  ...
  removePricingOverride(productId: string): Promise<
    ApiResponse<{
      removed: boolean;
    }>
  >;
